-- Supabase Database Setup for SparkStudio (Simplified)
...
-- Step 4: Create creative_prompts table
...
-- Step 8: Enable RLS on creative_submissions
ALTER TABLE public.creative_submissions ENABLE ROW LEVEL SECURITY;

-- Step 9: Create policies for creative_submissions
...
-- Step 12: Insert sample creative prompts
...
-- Step 13: Create storage bucket for creative media
